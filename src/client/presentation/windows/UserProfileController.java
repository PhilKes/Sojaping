...
public class UserProfileController extends UIControllerWithInfo {
    ...
    @FXML
    private Button btnSave, btnCancel, btnDeleteAccount, btnUploadPic, btnInvite, btnRemoveAvatar;
    ...
    private void onUploadPicClick() {
        ...
        if(file!=null && file.length()>3000000) {
            ...
            Image img=FXUtil.convertBase64ToImage(this.base64ProfilePic);
            imgAvatar.setImage(img);
            imgAvatar.setViewport(FXUtil.getImageCropBounds(img));
        }
    }
